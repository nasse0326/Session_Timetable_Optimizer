                ...
                {songs.map((song, idx) => {
                  ...
                  return (
                    <tr key={song.id} className="hover:bg-slate-900/40 transition-colors">
                      ...
                      <td className="px-2.5 py-2 text-slate-300 font-medium text-[11px]">
                        {song.bandName || <span className="text-slate-600">-</span>}
                      </td>
                      <td className="px-2.5 py-2 text-slate-400 text-[11px]">
                        {song.artist || <span className="text-slate-600">-</span>}
                      </td>
                      <td className="px-2.5 py-2 font-medium text-slate-100">
                        <div className="flex items-center gap-1 font-semibold text-slate-100 text-xs">
                          <Music2 className="w-3 h-3 text-indigo-400/80 shrink-0" />
                          <span>{song.title}</span>
                        </div>
                      </td>
                      <td className="px-2.5 py-2 text-slate-300 text-[11px]">
                        {song.rental ? (
                      ...
                      <td className="px-2.5 py-2">
                        {song.rawNotes ? (
                          <div className="flex items-center gap-1 text-amber-300/90 bg-amber-500/10 px-1.5 py-0.5 rounded border border-amber-500/20 w-fit">
